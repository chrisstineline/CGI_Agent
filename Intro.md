...
I stedet for én AI, der gør alt, opdeler man arbejdet i **specialiserede enheder**:

* **Agent** → Arbejder automatisk ud fra faste regler
* **Assistant** → Hjælper mennesker og kræver godkendelse
* **Proactive** → Tager opgaven og initierer arbejdet før promptet igang, ved at overvåge et område, der kan handles på, ud fra observationer gjort. 
...
2. En anden analyserer koden
	1. Handlingen startet af den første proaktive Agent
...
A["Customer Request"]
B["Agent analyzes task"]
C["Agent checks code"]
D["Assistant helps developer"]
...
* Mindre manuelt arbejde
	* Når den nye Jira-opgave oprettes, tager den  proaktive Agent opgaven, laver en analyse, estimerer opgavens størrelse og kompleksitet. Den kan f.eks. oprette sagen som en TDD opgave.
* Hurtigere iteration
...
| Alerts        | AI'en giver information på unormalheder der falder uden for den angivne struktur                                                                                                                            |
